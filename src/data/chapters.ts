...
export const walk: WalkPoint[] = [
  ...
  { position: [0, 2.3, 21.6], lookAt: [0, 2.0, 6], chapter: { roman: 'II', key: 'GATE', title: 'THE GATE', headline: 'Passing beneath the tiled roof.', copy: 'A single step marks the threshold between the street and the garden — the old rule that nothing hurried enters here.', tags: ['THRESHOLD', 'TIMBER', 'ARRIVAL'], side: 'right' } },
  ...
  { position: [-2.4, IY - 0.15, 0.5], lookAt: [-8, 1.0, -4.5], chapter: { roman: 'VI', key: 'TEAROOM', title: 'THE TEA ROOM', headline: 'Twelve mats, and nowhere to rush.', copy: 'A low table, four cushions and a tokonoma alcove — the room is built entirely around the pause.', tags: ['TATAMI', 'TOKONOMA', 'CHA-NO-YU'], side: 'right' } },
  { position: [0, IY, -0.6], lookAt: [0.5, 1.5, -12] },
  { position: [2.5, IY - 0.15, 0.5], lookAt: [10.5, 1.2, -2.5], chapter: { roman: 'VII', key: 'LIVING', title: 'THE LIVING ROOM', headline: 'A branch of blossom, doors to the garden.', copy: 'Glazed doors slide wide onto moss and stone, so that inside and outside share the same season.', tags: ['HINOKI', 'GLASS', 'GARDEN VIEW'], side: 'left' } },
